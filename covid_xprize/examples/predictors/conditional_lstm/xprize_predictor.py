...
class XPrizePredictor(object):
    ...
    def _construct_model(self, nb_context, nb_action, lstm_size=32, nb_lookback_days=21):
        ...
        model = construct_conditional_lstm_model(nb_context, nb_action, lstm_size, nb_lookback_days)
        training_model = construct_conditional_lstm_model(nb_context, nb_action, lstm_size, nb_lookback_days)

        model.compile(loss='mse', optimizer='adam', metrics=['mae'])
        training_model.compile(loss='mse', optimizer='adam', metrics=['mae'])
